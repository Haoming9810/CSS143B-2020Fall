...
- (10pt) Extra credits: Add a new integration test in IntegrationTest with a new test with at least 3 documents, and at least 5 search cases. This is a new test with new documents, not new additional documents to the existing test. And 5 search cases means 5 different search phrases.
